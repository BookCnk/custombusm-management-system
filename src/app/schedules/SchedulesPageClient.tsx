...
export default function SchedulesPageClient({
  ...
  const skipInitialLookupLoadRef = useRef(true);
  const skipInitialScheduleLoadRef = useRef(true);
  ...
  useEffect(() => {
    if (skipInitialLookupLoadRef.current) {
      skipInitialLookupLoadRef.current = false;
      return;
    }
  ...
  useEffect(() => {
    if (skipInitialScheduleLoadRef.current) {
      skipInitialScheduleLoadRef.current = false;
      return;
    }
